...
def join_war_rallies(device, stop_check=None):
    """Join castle, pass, or tower rallies — delegates to join_rally."""
    return join_rally([RallyType.CASTLE, RallyType.PASS, RallyType.TOWER],
                      device, stop_check=stop_check)
